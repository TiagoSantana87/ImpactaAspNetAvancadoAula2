...
namespace Empresa.Mvc.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public HomeController(EmpresaDbContext contexto,
            IDataProtectionProvider protectionProvider,
            IConfiguration configuracao)
        {
            _contexto = contexto;
            _protectorProvider = protectionProvider
                .CreateProtector(configuracao.GetSection("ChaveCriptografia").Value);
        ...
        public IActionResult Login(LoginViewModel viewModel)
        {
            ...
            var contato = _contexto.Contatos
                .Where(c => c.Email == viewModel.Email && 
            ...
            //var meuInteiro = default(int);

            var identidade = new ClaimsIdentity(claims, 
                _configuracao.GetSection("TipoAutenticacao").Value);
        ...
        public IActionResult Logout()
        {
            HttpContext
                .Authentication
                .SignOutAsync(_configuracao.GetSection("TipoAutenticacao").Value);
